...
require (
	...
	github.com/onflow/flow-cli v0.33.2-0.20220425184358-8797257ba650 // indirect
...
replace github.com/bjartek/go-with-the-flow/v2 => /Users/sadiefreeman/go-with-the-flow
